...
# Descrição
Atualmente o tempo de espera para a chegada de seu carro em vallets da Estapar é muito variável e pode demorar consideravelmente se a demanda for alta o suficiente. Portanto nossa solução torna-se um meio interesante de resolver esse problema reduzindo o tempo necesário para chegada de veículos. O surgimento de coleta de dados, especificamente em nossa solução, para avaliar a produtividade dos manobristas en função do tempo para esse informação ser usada de forma adequada para melhorias no sistema atual.
